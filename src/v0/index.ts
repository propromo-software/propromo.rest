...
import { SWAGGER_PATH, ROOT_PATHS, SWAGGER_PATH_EXCLUDE, V0_PATH } from '../config';
import { PROPROMO_BACKEND_SERVICE } from './adapters/backend/host';

export const V0 = new Elysia({ prefix: `/${V0_PATH}` })
    ...
    .use(swagger({
        ...
        documentation: {
            info: {
                ...
                description: 'A RestAPI for the scopes of the Github GraphqlAPI, that Propromo needs (dev).',
                version: '0.0.0',
            },
            tags: [
